...
Quick reference for web application security. Use alongside the `security` skill.
...
| 4 | Insecure Design | Threat modeling, spec-driven development (see the specify skill) |
