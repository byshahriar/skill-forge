...
- [ ] No secrets, tokens, passwords, or unredacted PII in any log line (hard rule from `security`)
...
For launch-day monitoring sequence and rollback triggers, see the `release` skill.
