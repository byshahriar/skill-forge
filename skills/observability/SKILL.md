...
**Never log secrets, tokens, passwords, or full PII.** This is a hard rule from the `security` skill — telemetry pipelines are a classic data-leak path. Allowlist fields; don't log whole request bodies.
