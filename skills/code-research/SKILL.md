...
For the underlying threat model (LLM01: Prompt Injection), follow the `security` skill — this section covers extraction hygiene, that one covers the threat model.
